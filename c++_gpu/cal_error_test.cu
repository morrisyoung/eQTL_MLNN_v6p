// the structure should be similar to cal_error.cu (the same model), but with different input and output variables, xxx_subtest
...
float cal_error_test(int k)
{
	...
	//==//==//==//==//==//==//==//==//==//==//==//==//==//==//==//==//==//==//==//==//==//==//==//==//==//==//==//==//==
	{
		...
		kernel_cal_cis_matrixmul<32><<< grid, threads >>>(d_Y_subtest_exp, dimension1, dimension2, d_X_subtest, X.get_dimension2(), d_list_cis_start, d_list_cis_end, d_beta_cis_sub, d_list_beta_cis_start);
	}
	//==//==//==//==//==//==//==//==//==//==//==//==//==//==//==//==//==//==//==//==//==//==//==//==//==//==//==//==//==
	...
	//==//==//==//==//==//==//==//==//==//==//==//==//==//==//==//==//==//==//==//==//==//==//==//==//==//==//==//==//==
	// func: d_Y_subtest_exp += d_Z_subtest x d_beta_batch_reshape;
	// dimension: (dimension1, dimension2) += (dimension1, dimension2_beta_batch) x (dimension2_beta_batch, dimension2)
	{
		...
		checkCudaErrors(cublasSgemm(handle, CUBLAS_OP_N, CUBLAS_OP_N, dimension2, dimension1, dimension2_beta_batch, &alpha, d_beta_batch_reshape, dimension2, d_Z_subtest, dimension2_beta_batch, &beta, d_Y_subtest_exp, dimension2));
	...
	// first layer
	//==//==//==//==//==//==//==//==//==//==//==//==//==//==//==//==//==//==//==//==//==//==//==//==//==//==//==//==//==
	// func: d_cellfactor_subtest = d_X_subtest x d_beta_cellfactor1_reshape;
	// dimension: (dimension1, dimension1_beta_cellfactor1) += (dimension1, dimension2_beta_cellfactor1) x (dimension2_beta_cellfactor1, dimension1_beta_cellfactor1)
	{
		...
		//note cublas is column primary! need to transpose the order
		//checkCudaErrors(cublasSgemm(handle, CUBLAS_OP_N, CUBLAS_OP_N, matrix_size.uiWB, matrix_size.uiHA, matrix_size.uiWA, &alpha, d_B, matrix_size.uiWB, d_A, matrix_size.uiWA, &beta, d_C, matrix_size.uiWB));
		checkCudaErrors(cublasSgemm(handle, CUBLAS_OP_N, CUBLAS_OP_N, dimension1_beta_cellfactor1, dimension1, dimension2_beta_cellfactor1, &alpha, d_beta_cellfactor1_reshape, dimension1_beta_cellfactor1, d_X_subtest, dimension2_beta_cellfactor1, &beta, d_cellfactor_subtest, dimension1_beta_cellfactor1));
		checkCudaErrors(cublasDestroy(handle));
	}
	//==//==//==//==//==//==//==//==//==//==//==//==//==//==//==//==//==//==//==//==//==//==//==//==//==//==//==//==//==

	// logistic twist: d_cellfactor_subtest
	//==//==//==//==//==//==//==//==//==//==//==//==//==//==//==//==//==//==//==//==//==//==//==//==//==//==//==//==//==
	{
		int block_size = 32;
		dim3 threads(block_size, block_size);
		dim3 grid( (dimension1_beta_cellfactor1+threads.x-1)/threads.x, (dimension1+threads.y-1)/threads.y );
		kernel_cal_matrix_logistic<32><<< grid, threads >>>(dimension1, dimension1_beta_cellfactor1, d_cellfactor_subtest);
	}
	//==//==//==//==//==//==//==//==//==//==//==//==//==//==//==//==//==//==//==//==//==//==//==//==//==//==//==//==//==
	...
	//==//==//==//==//==//==//==//==//==//==//==//==//==//==//==//==//==//==//==//==//==//==//==//==//==//==//==//==//==
	{
		...
		kernel_op_matrix_appendone<32><<< grid, threads >>>(dimension1, dimension1_beta_cellfactor1+1, d_cellfactor_subtest_new, d_cellfactor_subtest);
	}
	//==//==//==//==//==//==//==//==//==//==//==//==//==//==//==//==//==//==//==//==//==//==//==//==//==//==//==//==//==
	...
	//==//==//==//==//==//==//==//==//==//==//==//==//==//==//==//==//==//==//==//==//==//==//==//==//==//==//==//==//==
	// func: d_Y_subtest_exp += d_cellfactor_subtest_new x d_beta_cellfactor2_sub_reshape;
	// dimension: (dimension1, dimension2) += (dimension1, dimension2_beta_cellfactor2) x (dimension2_beta_cellfactor2, dimension2)
	{
		...
		//note cublas is column primary! need to transpose the order
		//checkCudaErrors(cublasSgemm(handle, CUBLAS_OP_N, CUBLAS_OP_N, matrix_size.uiWB, matrix_size.uiHA, matrix_size.uiWA, &alpha, d_B, matrix_size.uiWB, d_A, matrix_size.uiWA, &beta, d_C, matrix_size.uiWB));
		checkCudaErrors(cublasSgemm(handle, CUBLAS_OP_N, CUBLAS_OP_N, dimension2, dimension1, dimension2_beta_cellfactor2, &alpha, d_beta_cellfactor2_sub_reshape, dimension2, d_cellfactor_subtest_new, dimension2_beta_cellfactor2, &beta, d_Y_subtest_exp, dimension2));
		checkCudaErrors(cublasDestroy(handle));
	}
	//==//==//==//==//==//==//==//==//==//==//==//==//==//==//==//==//==//==//==//==//==//==//==//==//==//==//==//==//==
	...
	//=============
	{
		...
		//
		kernel_cal_sosod_subsum<32><<< grid, threads >>>(sub_amount, sub_length, dimension1*dimension2, d_sumY_temp, d_Y_subtest_exp, d_Y_subtest);
		//
